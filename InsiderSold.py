...
class insidetracksold:
    ...
    def trackerSold():
        ...
        symbolsSold = "//*[@class='sold']/ancestor::tr//a[@data-field='symbol']"
        ...
        volumeSold = "//*[@class='sold']/following-sibling::strong[1]"
        sharesSold = "//*[@class='sold']/following-sibling::strong[2]"
        bought = "//*[@class='bought']"
        sold = "//*[@class='sold']"
